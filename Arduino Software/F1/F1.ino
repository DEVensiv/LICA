...
boolean tagy = false;
boolean tagz = false;
boolean tagb2 = false; //tag for inition of 2nd phase for mill/drill
int drlx; //global var for drill
int drly;
int drlz;
int drlsp;
...
pinMode(11,INPUT);      //Digital Input (11)
pinMode(13,INPUT);      //Digital input (13)
